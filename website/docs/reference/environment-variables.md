...
| `CURSOR_API_KEY` | Cursor dashboard API key (`crsr_…`) for the native `cursor` provider ([cursor.com/dashboard/api](https://cursor.com/dashboard/api)). Requires `uv pip install cursor-sdk`. |
